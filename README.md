...
[camunda-archetype-servlet-war-demo-7.17.0](https://docs.camunda.org/manual/latest/user-guide/process-applications/maven-archetypes/).
...
### Unit Test
You can run the JUnit test [ProcessTest](src/test/java/ICICI/ProcessTest.java) in your IDE or using:
...
<!-- Tweet
New @Camunda example: Camunda Platform Process Application - A Process Application for [Camunda Platform](http://docs.camunda.org). https://github.com/camunda-consulting/code/tree/master/snippets/Creditcards
-->
